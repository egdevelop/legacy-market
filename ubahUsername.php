        ...
        <div class="w-100 position-fixed bg-white z-3 d-block d-sm-none py-4">
            <div class="container d-flex align-items-center justify-content-between">
                <a onclick="history.back()" class="text-dark d-flex align-items-center gap-3">
                    ...
                    <span class="fz-12 fw-bold fz-14">Ubah Username</span>
                </a>
                <div class="blue">
        ...
        <section class="mtProfil py-2 py-sm-4 px-0 px-sm-4 mb-5">
            <div class="container mb-4">
                <div class="row d-flex justify-content-between">
                    ...
                    <input value="Naufal" type="text" class="my-1 fz-12 border-0 bg-white col-12 d-block d-lg-none py-2"/>
                    <span class="fz-12 my-2">Maks. 10 Karakter</span>
                </div>
            </div>
