                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-9 right bg-white borad-10 p-4">
                        <div class="d-flex justify-content-between">
                            <div class="left">
                                <h6 class="fw-600">Masukkan Sandi Untuk Lanjut</h6>
                                <p class="fz-14 abu">Untuk mengubah email silahkan masukkan sandi anda</p>
                            </div>
                        </div>
                        <hr class="my-2 py-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <a href="ubah-email2.php"
                                            class="btn text-light fz-12 bg-blue px-4 py-2 borad-10 w-auto">Konfirmasi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
